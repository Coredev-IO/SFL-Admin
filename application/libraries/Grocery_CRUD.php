...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_layout()
	{
		...
		if ($this->unset_bootstrap) {
			...
			unset($css_files[sha1('Recursos/css/bootstrap.css')]);
			unset($css_files[sha1('Recursos/css/animate.css')]);
			unset($css_files[sha1('Recursos/css/font-awesome.css')]);
			unset($css_files[sha1('Recursos/css/style.css')]);
