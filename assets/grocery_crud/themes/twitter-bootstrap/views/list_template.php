<?php
	...
	$this->set_css('Recursos/css/animate.css');
	$this->set_css('Recursos/css/font-awesome.css');
	$this->set_css('Recursos/css/style.css');
	$this->set_css($this->default_theme_path.'/twitter-bootstrap/css/bootstrap.min22.css');
